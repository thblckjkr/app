...
print(Station.all().serialize())
# []

# Creating a station directly setting the properties
...
# masoniteorm.exceptions.QueryException: (1265, "Data truncated for column 'ip' at row 1") (With Mysql driver)
# With sqlite it just simply stores it as a string
